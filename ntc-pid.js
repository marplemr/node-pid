...
function mvToCNTC (milliVolts, ohmRef, offset) {
  ...
  var thermistorOhms = (( 3.3 * ohmRef) - (volts  * ohmRef)) / volts // 10kOhms reference
...
var ChDone = function(){
  ...
  if (count === 10) {
    ...
    console.log('Setpoint-Top: ', setTargetTop.toFixed(2) + ' F')
    console.log('Setpoint-Bot: ', setTargetBot.toFixed(2) + ' F')
    console.log('Temp Top --NTC-- Plate: ' + tempTopPlate.toFixed(2) + ' F')
